...
const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://api.novelora.my.id/api';
    ...
    try {
      ...
      const mappedNovels = chapters.map((ch: any) => {
        ...
        return {
          ...
          image: ch.novels?.image || 'https://images.unsplash.com/photo-1528698827591-e19ccd7bc23d?q=80&w=300&auto=format&fit=crop',

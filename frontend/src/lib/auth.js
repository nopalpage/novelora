 ...
 *
 * v2.0 — Separated deployment:
 *  - API calls now point to standalone Worker at VITE_API_URL (api.novelora.my.id)
 */
import { sb } from './supabase.js'

// URL backend Worker — sama dengan yang dipakai di api.js
const API_BASE = import.meta.env.VITE_API_URL || 'https://api.novelora.my.id'

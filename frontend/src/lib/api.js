// BASE URL ke Cloudflare Worker backend (akun thedarkcube313)
// Production : https://api.novelora.my.id/api
// Development: http://localhost:8787/api  (wrangler dev)
const BASE = (import.meta.env.VITE_API_URL || 'https://api.novelora.my.id') + '/api'

    ...
    <main className="flex-grow flex items-center justify-center p-4 min-h-[calc(100vh-140px)]">
      ...
      >
        ...
        <div className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
          {t("auth.noAccount")} <Link to="/register" className="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 inline-flex items-center gap-1 transition-colors">
            {t("auth.signUp")} <ArrowRight size={14} />
          </Link>
        </div>
      </motion.div>
    </main>
